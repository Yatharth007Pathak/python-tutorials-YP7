...
# Inverted Right-Angle Triangle with Numbers Decreasing Row-wise and Column-wise
...
for j in range(i, 0, -1): initiates a loop that iterates in reverse from i down to 1. 
